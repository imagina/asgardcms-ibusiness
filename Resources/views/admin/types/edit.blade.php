...
@section('content-header')
    <h1>
        {{ trans('ibusiness::types.title.edit type') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.ibusiness.type.index') }}">{{ trans('ibusiness::types.title.types') }}</a></li>
        <li class="active">{{ trans('ibusiness::types.title.edit type') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.ibusiness.type.update', $type->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('ibusiness::admin.types.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
